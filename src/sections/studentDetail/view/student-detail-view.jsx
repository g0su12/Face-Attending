  ...
  return (<Container>
    ...
    <Paper elevation={1} style={{padding: 20, marginTop: 20}}>
      <Grid container alignItems="center" justifyContent="center" spacing={2}>
        <Grid item xs={6}>
          <Avatar alt={student.name} src={student.photo} sx={{width: 400, height: 400, marginBottom: 2}}/>
        </Grid>
        <Grid item xs={6}>
    ...
    <Grid container spacing={2}>
      {Object.keys(student?.courses || {}).map((courseStudent) => (<PostCard
        key={courseStudent}
    ...
    <SessionInfo studentId={studentId} dbRef={dbRef} currentCourse={currentCourse} openModal={openModal}
